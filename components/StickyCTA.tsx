...
export default function StickyCTA({ routeInfo }: StickyCTAProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-sand-300 md:hidden z-50">
      <div className="container mx-auto px-4 py-3">
        <div className="flex gap-2">
          <button
            onClick={handleCall}
            className="flex-1 bg-primary-700 text-white px-4 py-3 rounded-lg font-semibold hover:bg-primary-800 transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="flex-1 bg-green-700 text-white px-4 py-3 rounded-lg font-semibold hover:bg-green-800 transition-colors flex items-center justify-center gap-2"
          >
